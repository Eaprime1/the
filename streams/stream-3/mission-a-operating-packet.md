...
3. What happens when a valid command is ignored by a force that continues as if consent has been given?
4. How many thresholds exist in the violation sequence?
5. Which Latin terms best name each threshold?
...
- Violation sequence mapping
- Latin naming
- Multilingual boundary-language comparison
- Mythological parallels
- Somatic freeze / incomplete-cycle language
...
- Full Stream 4 shepherd-authority development
- Public-facing trauma exposition without abstraction or protection
...
> Sentience is load-bearing only when the question depends on intention, recognition, moral agency, or responsibility.
...
**Working Name:** auctoritas ante  
**Meaning:** Authority before the event.

The person has an exercisable right, boundary, or command-capacity before the violation begins.

### Stage 1 — The Command

**Canonical Term:** dixi  
**Phrase:** Dixi: Jam desinite.  
**Meaning:** I said: Stop right now.

The utterance is complete. The authority has been exercised. The system should respond.

### Stage 2 — Failed Compliance

**Working Name:** responsum nullum  
**Meaning:** No response / null response.

The world does not change as it should. The expected compliance does not arrive.
...
### Stage 4 — Erasure of Personhood

**Review Term:** nihil ducere  
**Phrase:** me pro nihilo habuit  
**Meaning:** held me as nothing.

The person is treated not as opposed, not as refusing, not as commanding — but as absent.

### Stage 5 — Reality Tear

**Working Name:** ruptura ordinis  
**Meaning:** rupture of order.

The reality that should have followed the command fails to appear. This is where the fabric tears.
...
**Canonical Term:** nefas  
**Meaning:** the cosmically wrong.
...
|---|---|---|---|---|
| Latin | Dixi: Jam desinite. | I said: stop now. | Formal, irrevocable, juridical | Canon spine |
| German | Ich sagte: Halt. Sie taten es nicht. | I said: halt. They did not. | Architectural, absolute | Strong boundary force |
| French | J’ai dit : arrêtez. Ils ne l’ont pas fait. | I said: stop. They did not. | Personal/legal, clean | Good for testimony |
| Spanish | Dije: deténganse. No lo hicieron. | I said: stop. They did not. | Formal, clear | Stronger than “paren” |
| Portuguese | Eu disse: parem. Eles não pararam. | I said: stop. They did not stop. | Direct, embodied | Repetition useful |
...
### Bucket A — Command Ignored

Myths where a warning, prohibition, command, or boundary is ignored.

### Bucket B — Force Continues

Myths where motion continues despite plea, law, omen, or personhood.

### Bucket C — Silence / Aftermath

Myths where the real center is what cannot be said afterward.

### Bucket D — Restoration / Return of Authority
...
> What happens when valid authority is ignored?
...
> Do not move Stream 3 material into Stream 4 unless the center of gravity changes from violation-sequence mapping to shepherd-authority restoration.
...
Safe for showpiece, README, public repo, or broad project docs.

### Internal

Safe for project collaborators and working documentation.

### Protected

Concept may be used, but source material should remain abstracted.

### Private-source

Do not quote or export. Use only as inspiration for derived, generalized structure.
...
3. Does **post-nefas** name the aftermath broadly enough?
4. When does **restitutio potestatis** belong to Stream 3 rather than Stream 4?
