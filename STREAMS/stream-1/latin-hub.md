...
Latin is not the destination. It is the hub.

Like the Rosetta Stone (Greek, Demotic, Hieroglyph — same content, three carriers),
Latin holds the stable middle. When content passes through Latin, it finds its
precise shape — before it routes to the emotional body of a living language.

Latin does not carry feeling. It carries architecture.
The feeling is what the Romance languages add when they receive it.

---

## Established Terms

| Term | Meaning | Nuance | Proposed Fit |
|------|---------|--------|--------------|
| initium | Beginning — purely temporal | No cause implied, just the point of start | Timestamps, session anchors |
| origo | Origin, source | Where a thing came FROM — implies a source that persists | Diamond of Aces, seed documents |
| principium | First principle | The foundational cause, the why beneath the what | Core axioms |
| exordium | Opening of formal address | The threshold before the work begins — liminal by nature | MOAV packets, liminal READMEs |
